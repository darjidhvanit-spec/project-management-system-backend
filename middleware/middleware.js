...
const useAuthToken = async (req, res, next) => {
    try {
        const bypassLastPaths = ["register_user","user_login","user_list","user_update","user_delete","projectmember_add","project_list","project_add","projectmember_list","task_add","task_list","project_update","project_delete","projectmember_update","projectmember_delete"];
